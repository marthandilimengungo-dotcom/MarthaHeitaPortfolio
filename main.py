...
# --- THEME DESIGN SYSTEM (Slate Ocean Blue) ---
BG = '#0F172A'
SURFACE = '#1E293B'
TEXT = '#F8FAFC'
MUTED = '#94A3B8'
...
def main(page: ft.Page):
    page.title = "Martha Heita - SiteSpy Portfolio"
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=ft.Column([
                    ...
                    ft.Text("Martha Heita", size=34, weight=ft.FontWeight.W_900, color=TEXT),
                    ft.Row([
                        ...
                        ft.Text("marthandilimengungo@gmail.com", color=MUTED, size=14, selectable=True),
                    ], wrap=True),
                    ft.Row([
                        ft.Icon(ft.Icons.LINK, size=15, color=ACCENT),
                        ft.Text("GitHub Profile: github.com/marthandilimengungo-dotcom", color=ACCENT, size=14, selectable=True)
                    ], wrap=True),
                ], spacing=12)
            ),
    ...
    # Files list
    files_list = []
    for f in ['src/components/ErrorState.js', 'src/components/LoadingState.js', 'src/utils/validators.js']:
        files_list.append(
            ft.Container(
                padding=10,
                border_radius=6,
        ...
        content=ft.ResponsiveRow([
            ...
            ft.Container(
                ...
                content=tile_card("My Project Focus", [
                    ft.Text("Validation and loading/error feedback.", size=14, color=TEXT),
            ...
            ft.Container(
                ...
                content=tile_card("Submission Information", [
                    ...
                    ft.Text('git config user.name "Martha Heita"\ngit config user.email "marthandilimengungo@gmail.com"', size=11, font_family="Consolas", color=TEXT, selectable=True),
                    ft.Divider(color=BORDER),
    ...
    footer = ft.Container(
        ...
        content=ft.Column([
            ft.Text("Martha Heita | SiteSpy Portfolio Showcase", color=TEXT, size=14, weight=ft.FontWeight.BOLD),
